...
public class ColoredImageToGrayscale {
    ...
    public static void main(String[] args) {
        //to verify if our application is processing
        //the files singlethreaded or multithreaded
        //we will store the time when the main starts and
        //the time when it ends
        //if this value is somewhere lower than 5 ms
        //then we will now that our application processed
        //the files in multithreading
        long startingTime;
        long endingTime;
